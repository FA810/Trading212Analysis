...
def inject_theme_sidebar():
    ...
    # Hide native Streamlit navigation and force metric layout styling via CSS injection
    st.markdown("""
        <style>
    ...
    with st.sidebar:
        ...
        st.page_link("pages/1_Analisi_Dividendi.py", label="Dividends Analysis")
        st.page_link("pages/2_Registro_Transazioni.py", label="Transaction Log")
        st.page_link("pages/3_Analisi_Singolo_Titolo.py", label="Single Ticker Timeline")
        st.page_link("pages/4_Titoli_più_Movimentati.py", label="Most Active Stocks")
    ...
    return THEME_DICTIONARY[st.session_state.tema_scelto]